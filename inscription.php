            ...
            // Vérification de la valeur passée dans l'url : est-elle une clé du tableau ?   
             if(array_key_exists(strtolower($_GET['page']), $arrayPages))
                 ...
                 include('pages/'. $arrayPages[ strtolower($_GET['page']) ] );   
                   ...
                   include('pages/erreur-404.php');    }  }    else  {
                       // Non, on affiche la page d'accueil par défaut 
                          include('pages/'. $arrayPages['ini']);  }*/
//--------------------------------- TRAITEMENTS PHP ---------------------------------//
if($_POST)
{
    debug($_POST);
            ...
            $contenu .= "<div class='erreur'>Le pseudo doit contenir entre 1 et 20 caractères. <br> Caractère accepté : Lettre de A à Z et chiffre de 0 à 9</div>"; 
          ...
          else
              {
                ...
                // $_POST['mdp'] = md5($_POST['mdp']);
                            ...
                            <?php require_once("inc/haut.inc2.php"); ?>
                    ...
                    <img src="images/user_image2.jpg" id="icon" alt="User Icon" />
                              ...
                              <form method="post" action="">
                               ...
                               <label for="email">Email</label><br>  
                                  <input type="text" id="email" name="email" placeholder="exemple@gmail.com"><br><br>
