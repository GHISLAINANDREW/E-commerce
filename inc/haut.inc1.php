...
<html>
  <head>        
       ...
       <link href="inc/css/style1.css" type="text/css" rel="stylesheet">      
   	<link rel="stylesheet" href="<?php echo RACINE_SITE; ?>inc/css/style1.css">    
   </head>    
   <body>            
   	<header>            
   		<div class="conteneur">               
   	 <div style=" display: block; position: left;color: green">                 
               <a href="#" title="boom market network">BOOM MARKET NETWORK</a>
   		 </div>                
   		 <nav> 
